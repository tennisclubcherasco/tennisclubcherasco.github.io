...
function MyNavbar() {
    ...
    return (
        ...
        <Navbar style={{ height: "90px", width: "100%", backgroundColor: "#2f7157" }} className="d-flex justify-content-between">
            ...
            :
        <Navbar style={{ height: "90px", width: "100%", backgroundColor: "#2f7157" }} className="d-flex justify-content-between">
            <NavbarBrand className="navbar-title align-items-center d-flex p-0">
                <img
                    src={logoInvUrl}
                    ...
                    alt="Logo"
                />
                <h1 className={isScreenSmall ? "my-font ms-1 mb-0" : "my-font ms-3 mb-0"} style={{fontSize: "clamp(25px, 5vw, 50px)"}}>
